...
private:
    ...
    void Put(const char *keyName, std::unique_ptr<NetworkTables::Entry> value);
    void Send(NetworkTables::Entry *entry);
    void Got(bool confirmed, NetworkTables::Key *key, std::unique_ptr<NetworkTables::Entry> value);
