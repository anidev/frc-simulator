 ...
 */
std::vector<ParticleAnalysisReport>* BinaryImage::GetOrderedParticleAnalysisReports()
{
    std::vector<ParticleAnalysisReport>* particles = new std::vector<ParticleAnalysisReport>;
