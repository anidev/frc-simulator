...
#ifdef __FRC_CPP_SIM__
    // NOTE only works for current thread
    void** bt_buffer=new void*[10]; // 10 frames
    backtrace(bt_buffer,10);
    backtrace_symbols_fd(bt_buffer,10,2); // out to stderr
#else
    REG_SET regs;
