...
#define START_ROBOT_CLASS(_ClassName_) \
    ...
    extern "C" { \
        ...
        { \
            RobotBase::startRobotTask((FACTORYPTR)FRC_userClassFactory); \
            return 0; \
        } \
    }
...
public:
    ...
    static void startRobotTask(FACTORYPTR factory);
    static void robotTask(FACTORYPTR factory, Task *task);
